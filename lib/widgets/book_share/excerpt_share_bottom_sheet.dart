...
import 'package:songjiang_reader/widgets/book_share/excerpt_share_card.dart';
import 'package:songjiang_reader/widgets/icon_and_text.dart';
import 'package:songjiang_reader/widgets/show_loading.dart';
...
class _ExcerptShareBottomSheetState
  ...
  Future<void> _saveAsImage() async {
    ...
    final fileName = 'SongJiang_${widget.bookTitle.replaceAll(' ', '_')}';
