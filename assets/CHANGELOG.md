...
## 1.2.0 2024-11-17
❗SongJiang-Reader has changed the Android version signature, please back up and reinstall SongJiang-Reader❗
❗松江阅更换了 Android 版本的签名, 请做好备份重新安装松江阅❗

🚀You can now use SongJiang-Reader on Windows!
🚀现在可以在 Windows 上使用松江阅了！
